...
class Movie extends Component {
    ...
    callMovieList = async() => {
        await axios.get('http://www.kobis.or.kr/kobisopenapi/webservice/rest/boxoffice/searchDailyBoxOfficeList.json?key=ff32a090cbc342f38a1ffdd2b6576e5e&targetDt=20200101')
    ...
    render(){
        ...
        return(
            <div>
                <div className="jumbotron"><h1>날짜 : {showRange}</h1></div>
